        ...
        <form>
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="proveedor_razon_social" placeholder="Razon social"
                           value="<?php echo $proveedor->getRazonSocial(); ?>">
                </div>
                <div class="form-group">
                    <label for="proveedor_rfc">RFC</label>
                    <input type="text" class="form-control" id="proveedor_rfc" placeholder="RFC"
                           value="<?php echo $proveedor->getRfc(); ?>">
                </div>
                <div class="form-group">
                    <label for="proveedor_contacto">Contacto</label>
                    <input type="text" class="form-control" id="proveedor_contacto" placeholder="Nombre del contacto"
                           value="<?php echo $proveedor->getNombreContacto(); ?>">
                </div>
                <div class="form-group">
                    <label for="proveedor_telefono">Telefono</label>
                    <input type="text" class="form-control" id="proveedor_telefono" placeholder="Telefono"
                           value="<?php echo $proveedor->getTelefono(); ?>">
                </div>
                <div class="form-group">
                    <label for="proveedor_correo">Correo</label>
                    <input type="text" class="form-control" id="proveedor_correo" placeholder="Correo"
                           value="<?php echo $proveedor->getCorreo(); ?>">
                </div>
                <div class="form-group">
                    <label for="proveedor_observaciones">Observaciones</label>
                    <input type="text" class="form-control" id="proveedor_observaciones" placeholder="Observaciones"
                           value="<?php echo $proveedor->getObservaciones(); ?>">
                </div>
            </div>
        </form>
        <?php
